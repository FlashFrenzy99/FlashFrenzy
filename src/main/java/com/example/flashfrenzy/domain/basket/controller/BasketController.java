...
public class BasketController {
    ...
    public String getBasket(@AuthenticationPrincipal UserDetailsImpl userDetails, Model model) {
        ...
        List<BasketProductResponseDto> basketProducts = basketService.getBasket(
                userDetails.getUser());
    ...
    @PostMapping("/{id}")
    public String addBasket(@PathVariable(value = "id") Long basketId,
            @ModelAttribute BasketRequestForm requestForm) {
        long startTime = System.currentTimeMillis();
